...
import com.the0show.randommod.procedures.FireStickLivingEntityIsHitWithToolProcedure;
...
public class FireStickItem extends RandomModModElements.ModElement {
	@ObjectHolder("random_mod:fire_stick")
	public static final Item block = null;
	public FireStickItem(RandomModModElements instance) {
		super(instance, 3);
	}
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public boolean hitEntity(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
				...
				World world = entity.world;
				{
					...
					FireStickLivingEntityIsHitWithToolProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
