...
package com.the0show.randommod.world.dimension;
...
import com.the0show.randommod.item.DiamondDimentionItem;
...
public class DiamondDimentionDimension extends RandomModModElements.ModElement {
	@ObjectHolder("random_mod:diamond_dimention")
	public static final ModDimension dimension = null;
	@ObjectHolder("random_mod:diamond_dimention_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public DiamondDimentionDimension(RandomModModElements instance) {
		super(instance, 9);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("diamond_dimention"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("random_mod:diamond_dimention")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("random_mod:diamond_dimention"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("random_mod:diamond_dimention"));
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new DiamondDimentionItem().setRegistryName("diamond_dimention"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("diamond_dimention_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = DiamondDimentionDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("diamond_dimention_portal", Vec3i::compareTo, 300);
	@SubscribeEvent
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "diamond_dimention_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = DiamondDimentionDimension.CustomPortalBlock.createPatternHelper(this.world,
						blockpos);
			...
			if (!biomesPatched) {
				for (Biome biome : this.biomes) {
					biome.addCarver(GenerationStage.Carving.AIR, Biome.createCarver(new CaveWorldCarver(ProbabilityConfig::deserialize, 256) {
						{
							carvableBlocks = ImmutableSet.of(Blocks.DIAMOND_ORE.getDefaultState().getBlock(),
